...
(() => {
    ...
    const wave1 = Wave.init(waveCtx, wave.width, wave.height, 61, 0.005, 7, "rgba(71, 78, 161, 1)", 19, 23);

    const wave2 = Wave.init(waveCtx, wave.width, wave.height, 43, 0.007, 11, "rgba(99, 104, 244, 1)", 29, 31);

    const wave3 = Wave.init(waveCtx, wave.width, wave.height, 33, 0.01, 5, "rgba(110, 122, 255, 1)", 17, 37);
